...
public final class ClientGrpc {
  ...
  public static io.grpc.MethodDescriptor<SendM,
      com.google.protobuf.Empty> getNewMessageMethod() {
    io.grpc.MethodDescriptor<SendM, com.google.protobuf.Empty> getNewMessageMethod;
    if ((getNewMessageMethod = ClientGrpc.getNewMessageMethod) == null) {
      synchronized (ClientGrpc.class) {
        if ((getNewMessageMethod = ClientGrpc.getNewMessageMethod) == null) {
          ClientGrpc.getNewMessageMethod = getNewMessageMethod =
              io.grpc.MethodDescriptor.<SendM, com.google.protobuf.Empty>newBuilder()
              ...
              .setSchemaDescriptor(new ClientMethodDescriptorSupplier("newMessage"))
              .build();
        }
      }
    }
  ...
  public static abstract class ClientImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void newMessage(SendM request,
  ...
  public static final class ClientBlockingStub extends io.grpc.stub.AbstractBlockingStub<ClientBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty newMessage(SendM request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_NEW_MESSAGE:
          serviceImpl.newMessage((SendM) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
